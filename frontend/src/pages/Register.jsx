  ...
  return (
    <div className="min-h-[calc(100vh-160px)] bg-pink-gradient flex items-center justify-center py-16 px-4">
      <div className="w-full max-w-md relative">
        ...
        <div className="absolute -bottom-10 -left-10 w-20 h-20 rounded-full bg-primary/10 z-0"></div>
        <div className="absolute top-1/3 -left-5 w-10 h-10 rounded-full bg-primary/10 z-0"></div>
        <div className="absolute bottom-1/4 -right-5 w-10 h-10 rounded-full bg-primary/10 z-0"></div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full rounded-lg border ${
                        errors.name ? "border-destructive" : "border-input/50"
